...
## 1. De l’origen de l’Univers a la formació de la Terra

La història de la Terra no comença amb les primeres roques que podem estudiar. Els materials que formen el nostre planeta tenen una història molt anterior, relacionada amb l’evolució de l’Univers i amb la formació del Sistema Solar.
...
Aquesta observació, juntament amb altres evidències com la **radiació còsmica de fons**, sustenta el **model del Big Bang**. Segons aquest model, l’Univers va evolucionar a partir d’un estat inicial extremadament calent i dens fa aproximadament **13,8 Ga**.

El Big Bang no s’ha d’imaginar com una explosió de matèria que es produeix en un punt d’un espai buit. El model descriu l’**expansió de l’espai mateix**, de manera que les distàncies entre grans estructures de l’Univers augmenten amb el temps.

La radiació còsmica de fons constitueix una evidència especialment important. És una radiació molt feble que arriba de totes les direccions de l’espai i que correspon a una etapa molt primerenca de l’evolució de l’Univers, quan aquest ja s’havia expandit i refredat prou perquè la radiació pogués viatjar lliurement.

Per tant, la història inicial de l’Univers no s’ha observat directament. S’ha **reconstruït a partir d’evidències observables en el present** i de les lleis físiques que permeten interpretar-les.

### 1.2. L’origen dels elements químics

Durant les primeres etapes de l’Univers es varen formar sobretot els elements químics més lleugers, principalment **hidrogen i heli**.

Amb el temps, la gravetat va provocar la concentració de grans quantitats de matèria i es varen formar les primeres estrelles i galàxies. A l’interior de les estrelles, les temperatures i pressions elevades permeten reaccions de **fusió nuclear** que originen elements més pesants a partir d’elements més lleugers.

L’anàlisi de la llum procedent de les estrelles permet identificar els elements químics que contenen. Aquestes observacions, juntament amb el coneixement de les reaccions nuclears, permeten interpretar les estrelles com a llocs on es formen molts dels elements químics que avui trobam a l’Univers.

Durant l’evolució de les estrelles, una part d’aquests elements és retornada a l’espai. Successives generacions d’estrelles varen enriquir així el medi interestel·lar amb elements més pesants.

Això permet reconstruir una història de la matèria anterior a la Terra. Els elements que formen les roques, l’aigua i els éssers vius del nostre planeta no es varen originar tots al mateix temps: **una part important de la matèria a partir de la qual es va formar el Sistema Solar havia estat prèviament transformada en estrelles**.

### 1.3. La formació del Sistema Solar

Actualment podem observar **estrelles joves envoltades per discs de gas i pols**. També podem estudiar meteorits que conserven materials molt antics formats durant les primeres etapes del nostre Sistema Solar.

Aquestes i altres evidències permeten reconstruir la seva formació. Fa aproximadament **4,6 Ga**, una regió d’un núvol interestel·lar de gas i pols va començar a contreure’s per efecte de la gravetat.

La major part de la matèria es va concentrar a la zona central, on es va formar el **Sol**. La resta va quedar distribuïda en un disc de gas i pols que girava al seu voltant, el **disc protoplanetari**.

Dins aquest disc, petites partícules sòlides varen anar xocant i agregant-se. Aquest procés d’acumulació progressiva de materials s’anomena **acreció**. Amb el temps es varen formar cossos cada vegada més grans, els **planetesimals**, alguns dels quals varen continuar creixent fins a originar els planetes i altres cossos del Sistema Solar.

Les condicions no eren iguals a tot el disc. A les zones més pròximes al Sol, les temperatures elevades afavoriren la formació de planetes constituïts principalment per materials rocosos i metàl·lics, com Mercuri, Venus, la Terra i Mart. A més distància del Sol, les temperatures més baixes varen permetre incorporar una proporció més gran de substàncies volàtils.

Així, el model de formació del Sistema Solar no és només una narració sobre un passat inaccessible: és una **reconstrucció compatible amb les observacions de sistemes planetaris en formació, amb l’estudi dels meteorits i amb les característiques actuals del Sistema Solar**.

### 1.4. La formació de la Terra

La Terra es va formar fa aproximadament **4,54 Ga** mitjançant l’acreció de materials rocosos i metàl·lics presents en el Sistema Solar primitiu.

No conservam un registre complet d’aquesta etapa inicial. Una part important de la informació procedeix de la **datació radiomètrica de meteorits i de materials terrestres molt antics**, combinada amb l’estudi de la composició i l’estructura actuals del planeta.

Durant les primeres etapes de la seva història, els impactes entre cossos, la compressió gravitatòria i la desintegració d’isòtops radioactius varen aportar grans quantitats d’energia. L’interior terrestre va assolir temperatures elevades i els materials varen poder redistribuir-se segons les seves propietats.

Els materials més densos, especialment els rics en ferro i níquel, varen tendir a enfonsar-se cap a l’interior, mentre que els menys densos varen quedar a les zones més externes. Aquest procés s’anomena **diferenciació planetària** i va contribuir a establir l’organització interna de la Terra en grans zones com el nucli, el mantell i l’escorça.

A partir d’aquell planeta inicial, la Terra ha continuat transformant-se durant més de 4.500 milions d’anys.

Les evidències astronòmiques ens permeten reconstruir etapes anteriors a la formació del planeta. A partir de la formació de la Terra, una part de la seva història queda registrada en **roques, sediments, estructures i fòssils**. Aquest registre, però, no és complet.

![Seqüència simplificada de les grans etapes que connecten l’evolució de l’Univers amb la formació de la Terra.](figures/fig01-origen-univers-formacio-terra.png)

*Figura 1. Seqüència simplificada de les grans etapes que connecten l’evolució de l’Univers amb la formació de la Terra. Aquesta reconstrucció es basa en observacions actuals, evidències conservades i models científics.*

**Com podem reconstruir una història de milers de milions d’anys a partir d’un registre incomplet?**

Per respondre aquesta pregunta hem de començar per comprendre el **temps geològic** i la naturalesa del **registre geològic**.

## 2. El temps geològic i el registre geològic

### 2.1. El temps profund
...
### 2.3. El registre geològic és incomplet
...
### 2.4. El present ajuda a interpretar el passat
...
## 3. Datació relativa: ordenar els esdeveniments
...
### 3.2. Principi d’horitzontalitat original
...
### 3.3. Principi de continuïtat lateral
...
### 3.6. De les observacions a la seqüència temporal
...
## 4. Les discontinuïtats del registre geològic
...
### 4.1. Erosió i absència de sedimentació
...
### 4.2. Les discordances i altres discontinuïtats
...
## 5. Els fòssils com a evidències temporals
...
### 5.3. Correlacionar estrats mitjançant fòssils
...
### 5.4. El registre fòssil també és incomplet
...
## 6. Datació radiomètrica: assignar edats numèriques
...
### 6.1. Isòtops estables i radioactius
...
### 6.2. El període de semidesintegració
...
### 6.3. Expressió matemàtica de la desintegració radioactiva
...
### 6.4. Els isòtops com a rellotges geològics
...
### 6.5. No totes les roques es poden datar directament de la mateixa manera
...
## 7. Integrar la datació relativa i la datació radiomètrica
...
### 7.1. Situar una edat dins una seqüència d’esdeveniments
...
### 7.2. Acotar l’edat d’un esdeveniment
...
### 7.3. Construir una cronologia geològica
...
## 8. Reconstruir una història geològica
...
### 8.1. Reconèixer els elements del registre
...
### 8.3. Relacionar estructures i esdeveniments
...
### 8.4. Les superfícies actuals també tenen una història
...
### 8.5. Justificar la reconstrucció
...
### 8.6. No sempre podem reconstruir-ho tot
...
### 9.2. Com es varen establir les divisions del temps geològic?
...
### 9.3. De l’escala relativa a les edats numèriques
...
### 9.4. Una escala que es pot revisar
