...
Interpretar un tall geològic no consisteix simplement a identificar els elements que hi apareixen. L’objectiu és determinar **quins esdeveniments varen tenir lloc i en quin ordre**, i justificar aquesta seqüència a partir de les relacions observables.

### 7.1. Reconèixer els elements del registre

Un tall geològic senzill pot mostrar estrats sedimentaris, roques ígnies, plecs, falles, superfícies d’erosió, discontinuïtats o fòssils.

Cadascun d’aquests elements aporta informació diferent. Els estrats registren episodis de sedimentació; un plec indica que unes roques ja formades varen ser deformades; una falla talla i desplaça materials preexistents; una intrusió magmàtica travessa roques que ja existien; i una superfície d’erosió pot indicar la desaparició d’una part del registre.

Per reconstruir correctament la història no és necessari explicar encara amb detall els mecanismes que originen totes aquestes estructures. El que importa és reconèixer-les i interpretar les **relacions temporals** que mantenen entre si.

### 7.2. Ordenar els esdeveniments

La reconstrucció comença aplicant els principis de datació relativa.

La superposició permet ordenar els estrats sedimentaris. Les relacions de tall permeten situar temporalment falles i intrusions. L’horitzontalitat original ajuda a reconèixer deformacions posteriors a la sedimentació. Les superfícies d’erosió i les discordances indiquen interrupcions del registre.

Així, si tres estrats sedimentaris A, B i C apareixen plegats, són truncats per una superfície d’erosió i damunt seu hi ha un estrat horitzontal D, la seqüència mínima que explica les observacions és:

**sedimentació d’A → sedimentació de B → sedimentació de C → plegament → erosió → sedimentació de D**

No hem observat directament cap d’aquests esdeveniments. La seqüència s’ha deduït a partir de les relacions que han quedat conservades.


![Tall geològic amb estrats antics deformats, una discordança angular, sedimentació posterior, una intrusió magmàtica, una falla i modelatge erosiu recent.](figures/fig07-tall-geologic-integrador_v02.png.png)

*Figura 7. Les relacions entre estrats, estructures i discontinuïtats permeten reconstruir la successió d’esdeveniments que ha afectat una zona.*


### 7.3. Relacionar estructures i esdeveniments

Quan una estructura afecta diverses unitats geològiques, totes aquestes unitats havien d’existir abans que es produís l’esdeveniment.

Si una falla talla cinc estrats, els cinc estrats són anteriors a la falla. Si, en canvi, un sisè estrat cobreix la falla i no està afectat per aquesta, la sedimentació del sisè estrat és posterior al fallament.

El mateix raonament es pot aplicar a plegaments, intrusions o episodis d’erosió. Els fòssils guia poden ajudar a correlacionar determinats estrats amb registres d’altres zones, i les datacions radiomètriques poden proporcionar edats numèriques per a alguns materials. Totes aquestes dades s’han d’interpretar conjuntament.

### 7.4. Les superfícies actuals també tenen una història

La forma actual del terreny és el resultat més recent d’una successió de processos geològics. Quan l’erosió talla estrats, falles o altres estructures, aquesta erosió és posterior als elements que modifica.

Per això, en un tall geològic senzill, el **modelatge erosiu més recent** sol representar la darrera etapa recognoscible de la història mostrada, encara que la història geològica de la zona continuï.

Cal distingir aquesta erosió recent de les superfícies erosives antigues que poden haver quedat enterrades per sediments posteriors i formar part d’una discontinuïtat.

### 7.5. Justificar la reconstrucció

Una reconstrucció geològica ha d’estar formada per una seqüència d’esdeveniments compatible amb totes les evidències observades.

Per això, no basta indicar l’ordre dels esdeveniments. S’ha de poder explicar **quina observació justifica cada relació temporal**.

Per exemple:

**Observació:** una intrusió talla tres estrats sedimentaris.

**Inferència:** els tres estrats són anteriors a la intrusió.

**Principi aplicat:** relacions de tall.

Aquesta forma de raonar permet diferenciar les dades observables de les conclusions que se’n deriven.
...
Si dues estructures no es tallen, no es deformen mútuament ni mantenen cap altra relació que permeti comparar-les, pot ser impossible determinar quina és anterior.
