...
![Figura 1. Tall per reconstruir.](figures/a04-01-cas-integrador-parelles.png)
...
> **Evidència d’avaluació · CA 4.1**  
> Aquest repte es resol **individualment** i genera l’evidència principal de **CA 4.1**, perquè l’alumnat ha de seleccionar i combinar dades i relacions geològiques per reconstruir una història coherent, justificar les inferències temporals i distingir entre allò que les evidències permeten establir i allò que no es pot determinar.  
...
![Figura 2. Tall del repte individual.](figures/a04-02-repte-individual.png)
...
|---|---|---|
| ![Falla i intrusió](figures/a04-03-error-falla-intrusio.png) | ![Estrat entre dues capes datades](figures/a04-04-error-interval-datacions.png) | ![Dues estructures sense relació observable](figures/a04-05-error-estructures-sense-relacio.png) |
